...
abstract class ParentNode<NavTarget : Any>(
     ...
     */
    protected suspend inline fun <reified T : com.bumble.appyx.core.node.Node> attachChild(
     ...
     * you need one.
     */
    protected suspend inline fun <reified T : com.bumble.appyx.core.node.Node> waitForChildAttached(): T =
    ...
    open fun onChildFinished(child: com.bumble.appyx.core.node.Node) {
