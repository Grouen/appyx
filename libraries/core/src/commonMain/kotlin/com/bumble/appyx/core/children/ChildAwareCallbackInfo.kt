...
internal sealed class ChildAwareCallbackInfo {
    ...
    abstract fun onRegistered(activeNodes: List<com.bumble.appyx.core.node.Node>)
    ...
    class Single<T : Any>(
        ...
        fun onNewNodeAppeared(newNode: com.bumble.appyx.core.node.Node) {
        ...
        override fun onRegistered(activeNodes: List<com.bumble.appyx.core.node.Node>) {
    ...
    class Double<T1 : Any, T2 : Any>(
        ...
        fun onNewNodeAppeared(
            activeNodes: Collection<com.bumble.appyx.core.node.Node>,
            newNode: com.bumble.appyx.core.node.Node,
            ignoreNodes: Set<com.bumble.appyx.core.node.Node>,
        ) {
        ...
        private fun notify(node1: com.bumble.appyx.core.node.Node, node2: com.bumble.appyx.core.node.Node) {
            if (parentLifecycle.isDestroyed) return
            val lifecycle =
                MinimumCombinedLifecycle(
                    parentLifecycle,
        ...
        private fun getOther(node: com.bumble.appyx.core.node.Node): KClass<*>? =
            when {
